...
export default function Analytics() {
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-white mb-2">Environmental Analytics</h2>
        <p className="text-slate-300">Real-time insights from global monitoring systems</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
          <h3 className="text-xl font-semibold text-white mb-4">Alert Trends (Last 7 Days)</h3>
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">
        <h3 className="text-xl font-semibold text-white mb-4">Data Type Distribution</h3>
        <ResponsiveContainer width="100%" height={300}>
